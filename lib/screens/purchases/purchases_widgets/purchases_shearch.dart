...
class PurchaseSearch extends SearchDelegate {
  PurchaseSearch({required this.apiPath, required this.nameAtapi});
                  ...
                  builder: (controller) {
                    return InkWell(
                      onTap: () {
                        ...
                        // controller.listOfPurchaseModel.add(
                        //   PurchaseModel(
                        //       total: 500,
                        //       cost: snapshot.data![index].productName,
